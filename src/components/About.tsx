    ...
    >
      ...
      <ul className="list-none space-y-4">
        ...
        <li className="flex items-start space-x-3">
          ...
          <span>
            <strong>Learner & Explorer:</strong> Recently completed a Master’s in Computing Science at Griffith College Dublin, diving deeper into distributed systems and cloud-native architectures.
          </span>
        </li>
        <li className="flex items-start space-x-3">
